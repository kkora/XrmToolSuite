...
## EPIC-AI10 - AI-assisted architecture review of a Dataverse solution
...
## FEAT-AI10-0 - Scaffold & shared wiring `[Done]`

- **US-AI10-0.1** `[Done]` **As** a TOOLDEV, **I want** the tool to load in XrmToolBox with connection,
...
## FEAT-AI10-1 - Fact collection `[Done]`

- **US-AI10-1.1** `[Done]` **As** an architect, **I want** collectors that gather facts across plugins,
...
## FEAT-AI10-2 - Concern score & AI review `[Done]`

- **US-AI10-2** `[Done]` **As** an architect, **I want** a concern score and per-area metrics, **so that**
  I can see at a glance where the risk sits.
  - **AC:** Weighted severities produce a 0–100 concern score and a band. *(TC-AI10-REPORT-01..02)*
- **US-AI10-3** `[Done]` **As** an architect, **I want** an AI-authored review (executive summary,
  recommendations, modernization, refactoring, prioritized backlog, sprint plan), **so that** I get an
  actionable plan.
  - **AC:** The reviewer supplies an architecture-review system prompt covering all six sections. *(TC-AI10-REPORT-04)*
...
## FEAT-AI10-3 - Export `[Done]`

- **US-AI10-4** `[Done]` **As** an architect, **I want** to export the review to Word/PDF/HTML/Markdown/JSON,
