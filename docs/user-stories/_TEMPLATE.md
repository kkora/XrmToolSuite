...
`docs/user-stories/<YourTool>.md` and renames it - **replace the TODO placeholders with real work
items.** See the [index](README.md) for personas, ID scheme, and status legend.
