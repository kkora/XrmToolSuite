...
Area tag: **PA01**. See the [index](../README.md) for personas, ID scheme, and status legend. Traces to
`testing/Tools/FlowDependencyAnalyzer/TEST_CASES.md`.
...
## FEAT-PA01-0 - Scaffold & shared wiring `[Done]`

- **US-PA01.0.1** `[Done]` **As** a TOOLDEV, **I want** the tool to load in XrmToolBox with connection,
...
## FEAT-PA01-1 - Flow inventory and filtering `[Done]`

- **US-PA01.1.1** `[Done]` **As** an ALM engineer, **I want** all cloud flows listed with owner and status,
...
- **US-PA01.1.2** `[Done]` **As** a maker, **I want** to filter flows by solution, owner, status, connector,
...
## FEAT-PA01-2 - Trigger and Dataverse dependency analysis `[Done]`

- **US-PA01.2.1** `[Done]` **As** an ALM engineer, **I want** each flow's trigger type and (for Dataverse
...
- **US-PA01.2.2** `[Done]` **As** a maker, **I want** the Dataverse tables and columns each flow reads/writes
...
## FEAT-PA01-3 - Connector, connection-reference and environment-variable dependencies `[Done]`

- **US-PA01.3.1** `[Done]` **As** an ALM engineer, **I want** connectors, connection references and
...
- **US-PA01.3.2** `[Done]` **As** a release manager, **I want** flows using a direct connection instead of a
...
## FEAT-PA01-4 - Child-flow, custom-API and HTTP dependencies `[Done]`

- **US-PA01.4.1** `[Done]` **As** an Enterprise Architect, **I want** child-flow relationships and custom-API
...
- **US-PA01.4.2** `[Done]` **As** an ALM engineer, **I want** HTTP/action dependencies surfaced with any URLs
...
## FEAT-PA01-5 - Missing/hardcoded metadata risk findings `[Done]`

- **US-PA01.5.1** `[Done]` **As** a release manager, **I want** flows referencing deleted/missing metadata
...
- **US-PA01.5.2** `[Done]` **As** a Technical-Debt owner, **I want** hardcoded environment URLs, GUIDs and
...
## FEAT-PA01-6 - Component impact, dependency tree and export `[Done]`

- **US-PA01.6.1** `[Done]` **As** an ALM engineer, **I want** to pick a component (table, column, connector,
...
- **US-PA01.6.2** `[Done]` **As** a DEVOPS engineer, **I want** the dependency tree and findings exported to
