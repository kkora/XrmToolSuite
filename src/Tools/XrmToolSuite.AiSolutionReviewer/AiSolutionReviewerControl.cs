    ...
    public partial class AiSolutionReviewerControl : BaseToolControl, IGitHubPlugin, IHelpPlugin
    {
        ...
        private void ShowAiSettingsDialog()
        {
            ...
            })
            {
                ...
                var lblHint = new Label { Location = new Point(150, 118), Width = 260, Height = 40, ForeColor = Color.Gray, Font = new Font(Font.FontFamily, 7.5f), Text = "The API key is used this session only and is never saved. Only anonymized observations are sent." };
