...
namespace XrmToolSuite.FlowDependencyAnalyzer
{
    ...
    public class FlowDependencyAnalyzerPlugin : PluginBase
    {
        ...
        // SUBFOLDER named after this assembly (Plugins\XrmToolSuite.FlowDependencyAnalyzer\), the
        ...
        {
            Path.Combine(PluginDirectory, typeof(FlowDependencyAnalyzerPlugin).Assembly.GetName().Name),
            PluginDirectory,
        };
