...
namespace XrmToolSuite.SolutionMergeAssistant
{
    ...
    public class SolutionMergeAssistantPlugin : PluginBase
    {
        ...
        // SUBFOLDER named after this assembly (Plugins\XrmToolSuite.SolutionMergeAssistant\), the
        ...
        {
            Path.Combine(PluginDirectory, typeof(SolutionMergeAssistantPlugin).Assembly.GetName().Name),
            PluginDirectory,
        };
