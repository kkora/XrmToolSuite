...
namespace XrmToolSuite.SharingAnalyzer
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
     ExportMetadata("Name", "Sharing Analyzer"),
     ExportMetadata("Description", "Analyzes PrincipalObjectAccess (record-level sharing) by table and principal, flags excessive and stale shares, and recommends cleanup (Excel/PDF/JSON/HTML/CSV export)."),
    ...
    public class SharingAnalyzerPlugin : PluginBase
    {
        ...
        private static readonly string DependencyDirectory =
            Path.GetDirectoryName(typeof(SharingAnalyzerPlugin).Assembly.Location) ?? string.Empty;
        ...
        {
            return new SharingAnalyzerControl();
        }
    }
}
