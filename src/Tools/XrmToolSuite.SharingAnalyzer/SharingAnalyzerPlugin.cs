...
namespace XrmToolSuite.SharingAnalyzer
{
    ...
    public class SharingAnalyzerPlugin : PluginBase
    {
        ...
        // per-tool SUBFOLDER named after this assembly (Plugins\XrmToolSuite.SharingAnalyzer\), the
        ...
        {
            Path.Combine(PluginDirectory, typeof(SharingAnalyzerPlugin).Assembly.GetName().Name),
            PluginDirectory,
        };
