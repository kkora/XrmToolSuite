...
namespace XrmToolSuite.PortalHealthAnalyzer
{
    ...
    {
        // The Excel-export (ClosedXML) and native-PDF/Word (PdfSharp/MigraDoc) chains ship in the Plugins
        // ROOT alongside this DLL (NOT a subfolder): XrmToolBox's plugin analysis must be able to resolve
        // this tool's direct ClosedXML / PdfSharp / MigraDoc references at scan time, and our
