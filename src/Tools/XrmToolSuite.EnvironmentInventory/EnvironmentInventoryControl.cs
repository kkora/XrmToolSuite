...
namespace XrmToolSuite.EnvironmentInventory
{
    ...
    /// <summary>Generates a complete inventory of Dataverse environment assets (tables, columns, forms, views, roles, plugins, flows, web resources, environment variables, connection references) with export.</summary>
