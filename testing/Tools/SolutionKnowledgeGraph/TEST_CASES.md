...
| TC-SOLN09-EXPORT-08 | SVG | sample graph | a circle per node, self-contained | Automated | Pass |
...
| TC-SOLN09-COL-05 | Required outside solution | dependency A→external | edge added; external auto-created "Unknown" | Automated | Pass |
...
| TC-SOLN09-M-04 | Interactive view | Open interactive graph | Browser opens a draggable, searchable, filterable graph; click highlights trace/impact | Manual | Pending |
...
| TC-SOLN09-M-07 | Exports | Export GraphML / SVG / PNG / HTML | Each file opens; GraphML loads in yEd/Gephi | Manual | Pending |
